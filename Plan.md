...
**Saker jag kommer ha kvar från förslag**
...
**Förändringarna jag kommer göra är följande**
...
Men att ha en databas med fasta ingredienser funkar inte heller. (hmm??)
...
Använder närmaste avrundning för att visa hur många stjärnor? Behöver UserId då man bara ska kunna rösta en gång?
